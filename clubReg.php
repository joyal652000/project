                    ...
                    <form action="" method="post">
                        <div class="row gy-4 mb-3 ">
                            <div class="col-lg-6 form-group">
                                <input type="text" name="name" class="form-control" id="name" placeholder="Club Name" required>
                            </div>
                            <div class="col-lg-6 form-group">
...
if (isset($_POST['submit'])) {
    ...
    if ($password == $cPassword) {
        $qry = "INSERT INTO `club` (`clname`,`email`,`phone`,`address`,`district`,`pin`,`reg_no`) VALUES ('$name','$email','$phone','$address','$district','$pin','$reg')";
        // echo $qry;
        $qryLog = "INSERT INTO `login` (`uid`,`username`,`password`,`usertype`,`status`) VALUES ((SELECT MAX(`clid`) FROM `club`), '$email','$password','Club','Active')";
        // echo $qryLog;
